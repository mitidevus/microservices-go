...
type RouteTripFunc func(req *http.Request) *http.Response

func (f RouteTripFunc) RoundTrip(req *http.Request) (*http.Response, error) {
	return f(req), nil
}

func NewTestClient(fn RouteTripFunc) *http.Client {
	return &http.Client{
		Transport: fn,
	}
}
